...
## 提案
- 以 `/Users/wing/Develop/agent-moebius-www3/index2.html` 替换 `sites/marketeam/index.html`，继续保持单文件静态官网。
...
- 将已明确废弃的 `website-style-decision-v2.0.md` 和旧 `/Users/wing/Develop/agent-moebius-www/index.html` 隔离保存到 `docs/marketing-site/archive/`，并用 README 标明废弃状态，避免回流为当前依据。
