...
打开 sites/marketeam/index.html（agent-moebius 品牌）
  ...
  │     └─ 点击/Enter：两拍容器变形——先【拿起】（上抬/前移/44°→0° 转正/微放大提亮，黑胶架动作），再作为共享元素飞抵弹窗内工牌位（途中简化卡面渐变为完整工牌），变形面从足迹长成面板、内容不拉伸，【此时才显正面】= 正面放大工牌 + 角色名/charter/@用法（Esc/遮罩/按钮关=更快逆向：离窗缩回→放回插槽，键盘可达）
